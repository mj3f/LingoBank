...
public class GetLanguagesByUserIdQueryHandler : IRuntimeQueryHandler<GetLanguagesByUserIdQuery, Paged<LanguageDto>>
{
    private readonly LingoContext _context;

    public GetLanguagesByUserIdQueryHandler(LingoContext context) => _context = context;

    public async Task<Paged<LanguageDto>> ExecuteAsync(GetLanguagesByUserIdQuery query)
    {
